...
export default function RejectBookingModal({ isOpen, booking, onClose, onConfirm, loading }) {
  ...
  return (
    <div className="booking-modal-backdrop" role="dialog" aria-modal="true">
      <div className="booking-modal card">
        ...
        <p>
          Booking #{booking.id} for <strong>{booking.resourceName || booking.resourceId}</strong>
        </p>
